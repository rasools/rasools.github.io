    ...
    content:
      ...
      items:
        ...
        - title: Project Leader
          ...
          date_end: ''
          description: |2-
              Since its invention in 2012, CRISPR technology has transformed the face of life science by enabling the generation of thousands of cell lines originating from a wide range of tissues and a myriad of transgenic animals recapitulating disease phenotypes. Huge excitement around the revolutionary aspects of CRISPR-based studies and increasing support from funding agencies have translated into the number of edited cell lines vastly growing every year. The annotation of CRISPR-related articles and extraction of key content has traditionally relied on manual efforts. Manual annotation is error-prone and time-consuming. We explored a novel approach to keyphrase extraction in CRISPR-related articles by harnessing transfer learning and pre-trained Transformer models, specifically Sentence Transformers. Through fine-tuning with a specialized dataset containing articles and key sentences, this study showcases the effectiveness of these models, achieving an impressive Average R-precision of 90.4%. Time savings and workflow efficiency enhancements make this methodology highly valuable in information retrieval. AddCell provides the research community, legislators, regulators, and the general public with a large and in-depth overview of the current status of CRISPR-edited cell lines.
